...
namespace ClinicaJurassica.Models
{
    ...
    public class Paciente
    {
        ...
        [Column("sexo_genero"), Required, StringLength(40)] public string SexoGenero { get; set; } = string.Empty;
        [Column("telefone_celular"), Required, RegularExpression(@"^\d{10,11}$")]
        public string TelefoneCelular { get; set; } = string.Empty;
        [Column("telefone_secundario"), RegularExpression(@"^\d{10,11}$|^$")]
        public string? TelefoneSecundario { get; set; }
        [Required, MinLength(6), JsonIgnore] public string Senha { get; set; } = string.Empty;
